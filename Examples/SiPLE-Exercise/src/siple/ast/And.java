...
/**
 * @production And : {@link LogicExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:55
 */
public class And extends LogicExpression implements Cloneable {
  /**
   * @apilevel low-level
   */
   ...
   * @declaredat ./../../specifications/semantics/Interpretation.jrag:179
   */
   ...
   * 
   */
  public And(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
