...
/**
 * @production GreaterThan : {@link EqualityExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:61
 */
public class GreaterThan extends EqualityExpression implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public GreaterThan clone() throws CloneNotSupportedException {
    GreaterThan node = (GreaterThan)super.clone();
  ...
  public GreaterThan copy() {
      try {
        GreaterThan node = (GreaterThan)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public GreaterThan fullCopy() {
    try {
      GreaterThan tree = (GreaterThan) clone();
   ...
   * @declaredat ./../../specifications/semantics/Interpretation.jrag:204
   */
   ...
   * 
   */
  public GreaterThan(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
