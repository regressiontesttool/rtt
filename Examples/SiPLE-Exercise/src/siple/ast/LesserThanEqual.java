...
/**
 * @production LesserThanEqual : {@link EqualityExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:64
 */
public class LesserThanEqual extends EqualityExpression implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public LesserThanEqual clone() throws CloneNotSupportedException {
    LesserThanEqual node = (LesserThanEqual)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public LesserThanEqual copy() {
      try {
        LesserThanEqual node = (LesserThanEqual)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public LesserThanEqual fullCopy() {
    try {
      LesserThanEqual tree = (LesserThanEqual) clone();
   ...
   * @declaredat ./../../specifications/semantics/Interpretation.jrag:231
   */
   ...
   * 
   */
  public LesserThanEqual(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
