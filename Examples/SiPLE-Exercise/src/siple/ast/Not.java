...
/**
 * @production Not : {@link UnaryExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:44
 */
public class Not extends UnaryExpression implements Cloneable {
	/**
	 * @apilevel low-level
	 */
	...
	/**
	 * ALU Operations ** @ast method
	 * 
	 * @aspect Interpretation
	 * @declaredat ./../../specifications/semantics/Interpretation.jrag:152
	 */
	 ...
	 * @attribute syn
	 * @aspect TypeAnalysis
	 * @declaredat ./../../specifications/semantics/TypeAnalysis.jrag:77
	 */
	@SuppressWarnings({ "unchecked", "cast" })
	@Parser.Node.Compare
	public Type Type() {
	...
	private Type Type_compute() {
		return getOperand().Type().isBoolean() ? Type.Boolean : Type.ERROR_TYPE;
	}
