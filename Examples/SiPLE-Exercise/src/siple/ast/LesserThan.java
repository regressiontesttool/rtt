...
/**
 * @production LesserThan : {@link EqualityExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:62
 */
public class LesserThan extends EqualityExpression implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public LesserThan fullCopy() {
    try {
      LesserThan tree = (LesserThan) clone();
   ...
   * @declaredat ./../../specifications/semantics/Interpretation.jrag:213
   */
