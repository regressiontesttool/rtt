...
/**
 * @production Subtraction : {@link ArithmeticExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:69
 */
public class Subtraction extends ArithmeticExpression implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public Subtraction clone() throws CloneNotSupportedException {
    Subtraction node = (Subtraction)super.clone();
  ...
  public Subtraction copy() {
      try {
        Subtraction node = (Subtraction)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public Subtraction fullCopy() {
    try {
      Subtraction tree = (Subtraction) clone();
   ...
   * @declaredat ./../../specifications/semantics/Interpretation.jrag:250
   */
   ...
   * 
   */
  public Subtraction(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
