...
/**
 * @production GreaterThanEqual : {@link EqualityExpression};
 * @ast node
 * @declaredat ./../../specifications/semantics/ast.ast:63
 */
public class GreaterThanEqual extends EqualityExpression implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public GreaterThanEqual clone() throws CloneNotSupportedException {
    GreaterThanEqual node = (GreaterThanEqual)super.clone();
  ...
  public GreaterThanEqual copy() {
      try {
        GreaterThanEqual node = (GreaterThanEqual)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public GreaterThanEqual fullCopy() {
    try {
      GreaterThanEqual tree = (GreaterThanEqual) clone();
   ...
   * @declaredat ./../../specifications/semantics/Interpretation.jrag:222
   */
   ...
   * 
   */
  public GreaterThanEqual(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
