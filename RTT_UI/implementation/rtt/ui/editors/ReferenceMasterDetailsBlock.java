...
public class ReferenceMasterDetailsBlock extends MasterDetailsBlock {
	...
	public static final int GENERATED_BY_COLUMN = 1;
	...
	protected void createMasterPart(final IManagedForm managedForm, Composite parent) {
		...
		// Node column
		TreeColumn elementColumn = new TreeColumn(
				elementTree, SWT.LEAD, NODE_COLUMN);
		elementColumn.setText("Node");
		elementColumn.setMoveable(true);
		
		columnLayout.setColumnData(elementColumn, 
