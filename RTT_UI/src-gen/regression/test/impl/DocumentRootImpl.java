 ...
 * <ul>
 *   <li>{@link regression.test.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link regression.test.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link regression.test.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link regression.test.impl.DocumentRootImpl#getLexerOutput <em>Lexer Output</em>}</li>
 *   <li>{@link regression.test.impl.DocumentRootImpl#getParserOutput <em>Parser Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
