 ...
 * <ul>
 *   <li>{@link regression.test.impl.TreeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link regression.test.impl.TreeImpl#getNode <em>Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TreeImpl extends ClassableImpl implements Tree {
	/**
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, TestPackage.TREE__GROUP);
		}
		return group;
	}
	...
	public EList<Node> getNode() {
		return getGroup().list(TestPackage.Literals.TREE__NODE);
	}
