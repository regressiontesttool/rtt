		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_to_feature", "_UI_Reference_type"),
				 TestPackage.Literals.REFERENCE__TO,
				 true,
				 false,
				 false,
