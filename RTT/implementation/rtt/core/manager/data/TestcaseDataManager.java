...
public abstract class TestcaseDataManager extends DataManager<History> implements IHistoryManager {
	...
	public TestcaseDataManager(ArchiveLoader loader, String suiteName,
