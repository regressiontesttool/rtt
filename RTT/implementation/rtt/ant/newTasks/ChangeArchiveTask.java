...
public class ChangeArchiveTask extends WriteArchiveTask {
	
	public static abstract class ChangeTask extends Task {	
		
		private boolean archiveChanged = false;

		public abstract void checkIntegrity(Manager manager) throws BuildException;
	...
	public void checkIntegrity(Manager manager)
		...
		for (ChangeTask task : tasks) {
			task.checkIntegrity(manager);
		}
	}
	
	@Override
	protected boolean executeTask(Manager manager) {
