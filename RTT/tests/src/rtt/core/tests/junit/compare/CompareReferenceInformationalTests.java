...
public class CompareReferenceInformationalTests {
	...
	public void testUnequalReferenceAttribute() throws Exception {
		...
		testDifference(createSampleReference(true), changedReference, Difference.REFERENCE);
		testDifference(changedReference, createSampleReference(true), Difference.REFERENCE);
		testNoDifferences(changedReference, changedReference);
	}
